...
const CityRelatedProducts = ({ city }) => {
  const relatedProducts = [
    {
      name: "By Range",
      slug: "/product/by-range",
      description: `Aluminium Windows & Doors by Range in ${city.name}`,
      image: "/img/e-catalogue-product-1.webp",
    },
    {
      name: "By Room",
      slug: "/product/by-room",
      description: `Aluminium Windows & Doors by Room in ${city.name}`,
      image: "/img/e-catalogue-product-2.webp",
    },
    {
      name: "All Products",
      slug: "/product",
      description: `Browse all WinZone products available in ${city.name}`,
    ...
    <section className="bg-[#F7F7F7]">
      <div className="section-container py-12">
        <CommonTitle
          ...
          extraTitleCss=""
          description={`Discover our complete range of windows and doors available in ${city.name}`}
...
export default CityRelatedProducts;
