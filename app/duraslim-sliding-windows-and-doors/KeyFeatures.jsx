...
const keyFeatures = [
  ...
  },
  {
    ...
    description: "High-quality sliding hardware ensures effortless operation with smooth gliding mechanisms.",
  },
  {
    icon: "safety",
  ...
  return (
    <div className="section-container">
      <CommonTitle
          ...
          title="KEY FEATURES"
          extraTitleCss=""
          description="Discover the exceptional features that make our Duraslim sliding windows and doors stand out"
