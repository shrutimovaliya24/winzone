...
const galleryImages = [
  {
    ...
    alt: "Duraslim Sliding Windows Installation",
  },
  {
    src: "/img/duraslim-sliding-img/duraslim-sliding-3.webp",
    alt: "Modern Sliding Window Design",
  },
  {
    src: "/img/duraslim-sliding-img/duraslim-sliding-4.webp",
    alt: "Slim Profile Sliding Doors",
  },
];

const DuraslimSlidingGallery = () => {
  return (
    <div className="section-container">
      <CommonTitle
        tag="GALLERY"
        extraTagCss="bg-theme-color/6"
        title="DURASLIM SLIDING WINDOWS & DOORS GALLERY"
        extraTitleCss=""
        description="Explore our beautiful Duraslim sliding window and door installations"
...
export default DuraslimSlidingGallery;
