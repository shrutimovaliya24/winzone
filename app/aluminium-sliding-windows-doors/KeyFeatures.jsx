...
const keyFeatures = [
  {
    ...
    description: "Sliding windows maximize space efficiency by eliminating the need for swing clearance, perfect for modern living spaces.",
  },
  {
    icon: "safety",
    title: "Smooth Operation",
    description: "High-quality sliding hardware ensures effortless operation with smooth gliding mechanisms for easy daily use.",
  },
  {
    icon: "greenBuilding",
    title: "Thermal Insulation",
    description: "Advanced thermal break technology maintains comfortable room temperature while reducing energy costs.",
  },
  {
    icon: "innovative",
    title: "Modern Aesthetics",
    description: "Sleek, contemporary design enhances architectural aesthetics with maximum natural light and ventilation.",
  },
  {
    icon: "safety",
  ...
  return (
    <div className="section-container">
      <CommonTitle
          ...
          title="KEY FEATURES"
          extraTitleCss=""
          description="Discover the exceptional features that make our sliding windows and doors stand out"
