...
const galleryImages = [
  {
    src: "/img/sliding-img/sliding-1.webp",
    alt: "Aluminium Sliding Windows Installation",
  },
  {
    src: "/img/sliding-img/sliding-3.webp",
    alt: "Modern Sliding Window Design",
  },
  {
    src: "/img/sliding-img/sliding-4.webp",
  ...
  return (
    <div className="section-container">
      <CommonTitle
        ...
        title="SLIDING WINDOWS & DOORS GALLERY"
        extraTitleCss=""
        description="Explore our beautiful sliding window and door installations"
