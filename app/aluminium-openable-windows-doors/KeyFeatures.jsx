...
const keyFeatures = [
  {
    ...
    description: "Multiple opening options including casement, tilt-and-turn, and awning styles provide optimal ventilation control.",
  },
  {
    icon: "safety",
  ...
  },
  {
    icon: "innovative",
    title: "Modern Design",
    description: "Sleek, contemporary design enhances architectural aesthetics with maximum natural light.",
  },
  {
    icon: "safety",
  ...
  return (
    <div className="section-container">
      <CommonTitle
          ...
          title="KEY FEATURES"
          extraTitleCss=""
          description="Discover the exceptional features that make our openable windows and doors stand out"
