...
const galleryImages = [
  {
    ...
    alt: "Aluminium Openable Windows Installation",
  },
  {
    src: "/img/openable-img/openable-3.webp",
    alt: "Modern Openable Window Design",
  },
  {
    src: "/img/openable-img/openable-4.webp",
    alt: "Casement Windows",
  },
];

const OpenableGallery = () => {
  return (
    <div className="section-container">
      <CommonTitle
        tag="GALLERY"
        extraTagCss="bg-theme-color/6"
        title="OPENABLE WINDOWS & DOORS GALLERY"
        extraTitleCss=""
        description="Explore our beautiful openable window and door installations"
...
export default OpenableGallery;
