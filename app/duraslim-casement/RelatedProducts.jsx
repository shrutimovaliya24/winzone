  ...
  const relatedProducts = [
    {
      ...
      description: "Duraslim Casement Tilt and Turn Windows",
    ...
    <section className="bg-[#F7F7F7]">
      <div className="section-container py-12">
        <CommonTitle
          ...
          title="EXPLORE OTHER DURASLIM PRODUCTS"
          extraTitleCss=""
          description="Discover our other Duraslim window and door solutions"
