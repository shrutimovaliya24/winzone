...
const keyFeatures = [
  ...
  },
  {
    ...
    description: "Side-hinged opening design provides excellent ventilation control and easy operation.",
  },
  {
    icon: "innovative",
  ...
  },
  {
    ...
    description: "Long-lasting construction ensures years of reliable performance and value.",
  },
  {
    icon: "rocket",
  ...
  return (
    <div className="section-container">
      <CommonTitle
          ...
          title="KEY FEATURES"
          extraTitleCss=""
          description="Discover the exceptional features that make our Essential casement windows stand out"
