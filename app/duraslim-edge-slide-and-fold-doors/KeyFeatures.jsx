...
const keyFeatures = [
  {
    icon: "energy",
    title: "Flexible Opening",
    description: "Panels fold and slide to create wide openings, perfect for seamless indoor-outdoor connections.",
  },
  {
    icon: "safety",
    title: "Space Efficient",
    description: "Panels stack neatly when open, maximizing space efficiency while providing wide access.",
  },
  {
    icon: "greenBuilding",
  ...
  },
  {
    ...
    description: "High-quality hardware ensures effortless operation with smooth folding and sliding mechanisms.",
  },
  {
    icon: "safety",
  ...
  return (
    <div className="section-container">
      <CommonTitle
          ...
          title="KEY FEATURES"
          extraTitleCss=""
          description="Discover the exceptional features that make our Duraslim Edge slide and fold doors stand out"
