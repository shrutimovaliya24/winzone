...
const RelatedProducts = () => {
  const relatedProducts = [
    ...
    },
    {
      ...
      image: "/img/e-catalogue-product-4.webp",
    },
  ];
    ...
    <section className="bg-[#F7F7F7]">
      <div className="section-container py-12">
        <CommonTitle
          ...
          title="EXPLORE OTHER ROOM SOLUTIONS"
          extraTitleCss=""
          description="Discover our aluminium windows and doors for other rooms in your home"
