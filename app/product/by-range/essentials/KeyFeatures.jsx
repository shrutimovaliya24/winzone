...
const keyFeatures = [
  ...
  },
  {
    ...
    description: "Range includes casement, slider, and pro slider windows for various applications.",
  },
  {
    icon: "innovative",
  ...
  return (
    <div className="section-container">
      <CommonTitle
          ...
          title="KEY FEATURES"
          extraTitleCss=""
          description="Discover the exceptional features of the Essentials range"
