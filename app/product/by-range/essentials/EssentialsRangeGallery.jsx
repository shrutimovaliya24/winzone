...
const galleryImages = [
  {
    ...
    alt: "Essentials Range Installation",
  },
  {
    src: "/img/essentials-range-img/essentials-range-3.webp",
    alt: "Value Window Design",
  },
  {
    src: "/img/essentials-range-img/essentials-range-4.webp",
    alt: "Affordable Windows",
  },
];

const EssentialsRangeGallery = () => {
  return (
    <div className="section-container">
      <CommonTitle
        tag="GALLERY"
        extraTagCss="bg-theme-color/6"
        title="ESSENTIALS RANGE GALLERY"
        extraTitleCss=""
        description="Explore our beautiful Essentials range installations"
...
export default EssentialsRangeGallery;
