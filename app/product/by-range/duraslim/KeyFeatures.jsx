...
const keyFeatures = [
  {
    icon: "energy",
    title: "Ultra-Slim Profiles",
    description: "Slim profile design maximizes glass area and natural light while maintaining structural integrity.",
  },
  {
    icon: "safety",
  ...
  },
  {
    ...
    description: "Range includes casement, tilt and turn, and sliding windows and doors for various applications.",
  },
  {
    icon: "innovative",
  ...
  return (
    <div className="section-container">
      <CommonTitle
          ...
          title="KEY FEATURES"
          extraTitleCss=""
          description="Discover the exceptional features of the Duraslim range"
