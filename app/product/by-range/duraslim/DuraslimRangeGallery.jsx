...
const galleryImages = [
  {
    ...
    alt: "Duraslim Range Installation",
  },
  {
    src: "/img/duraslim-range-img/duraslim-range-3.webp",
    alt: "Ultra-Slim Window Design",
  },
  {
    src: "/img/duraslim-range-img/duraslim-range-4.webp",
    alt: "Modern Slim Profile Windows",
  },
];

const DuraslimRangeGallery = () => {
  return (
    <div className="section-container">
      <CommonTitle
        tag="GALLERY"
        extraTagCss="bg-theme-color/6"
        title="DURASLIM RANGE GALLERY"
        extraTitleCss=""
        description="Explore our beautiful Duraslim range installations"
...
export default DuraslimRangeGallery;
