    ...
    <section className="bg-[#F7F7F7]">
      <div className="section-container py-12">
        <CommonTitle
          ...
          title="EXPLORE OTHER DURASLIM EDGE PRODUCTS"
          extraTitleCss=""
          description="Discover our other Duraslim Edge window and door solutions"
