...
const keyFeatures = [
  ...
  },
  {
    ...
    description: "Despite minimal frames, the construction maintains excellent structural integrity and durability.",
  },
  {
    icon: "rocket",
  ...
  return (
    <div className="section-container">
      <CommonTitle
          ...
          title="KEY FEATURES"
          extraTitleCss=""
          description="Discover the exceptional features that make our Duraslim Edge minimal windows and doors stand out"
